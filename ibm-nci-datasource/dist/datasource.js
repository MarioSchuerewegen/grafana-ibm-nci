System.register(["moment", "lodash"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var moment_1, lodash_1, IPMDatasource;
    return {
        setters: [
            function (moment_1_1) {
                moment_1 = moment_1_1;
            ...
            IPMDatasource = (function () {
                ...
                IPMDatasource.prototype.query = function (options) {
                    ...
                    var requests = lodash_1.default.map(options.targets, function (target) {
                        ...
                        if (target.columns) {
                            for (var _i = 0, _a = target.columns; _i < _a.length; _i++) {
                                var OneColumn = _a[_i];
                        ...
                        ;
                        return {
                            url: _this.url + '/datasources/' + encodeURIComponent(target.DataSource) + '/datasets/' + target.DataType + '/items',
                ...
                IPMDatasource.prototype.getDataSources = function () {
                    var request = {
                        url: this.url + '/datasources'
                    };
                    return this.doSimpleHttpGet(request);
                };
                IPMDatasource.prototype.getDataTypes = function (DataSource) {
                ...
                IPMDatasource.prototype.getFields = function (DataSource, DataType) {
                    var aT = DataSource.replace(/^.*-->  /, '');
                ...
                IPMDatasource.prototype.getTimeFields = function (DataSource, DataType) {
                    var aT = DataSource.replace(/^.*-->  /, '');
                    var aG = DataType.replace(/^.*-->  /, '');
                    var ret = "";
                    if (aT != "") {
                ...
                IPMDatasource.prototype.getPrimaryKey = function (DataSource, DataType) {
                    var aT = DataSource.replace(/^.*-->  /, '');
                    var aG = DataType.replace(/^.*-->  /, '');
                    var ids = [];
                    if (aT != "") {
                ...
                IPMDatasource.prototype.getParameters = function (DataSource, DataType) {
                    var aT = DataSource.replace(/^.*-->  /, '');
                    var aG = DataType.replace(/^.*-->  /, '');
                    var ids = [];
                    if (aT != "") {
